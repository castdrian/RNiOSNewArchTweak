...
public:
  virtual jsi::String systemVersion(jsi::Runtime &rt) = 0;
...
public:
  ...
  static constexpr std::string_view kModuleName = "NativeTestModule";
...
private:
  ...
  public:
    ...
    jsi::String systemVersion(jsi::Runtime &rt) override {
      static_assert(
          bridging::getParameterCount(&T::systemVersion) == 1,
          "Expected systemVersion(...) to have 1 parameters");

      return bridging::callFromJs<jsi::String>(
          rt, &T::systemVersion, jsInvoker_, instance_);
    }
